...
function Order({ params }) {   
    ...
    const [{ loading, order, error, successPay }, dispatch] = useReducer(reducer, {
        loading: true,
        order: {},
        error: ''
    })

    const { shippingAddress, paymentMethod, orderItems, itemsPrice, taxPrice, shippingPrice, totalPrice, isDelivered, isPaid, deliveredAt, paidAt } = order
